...
-(void)save:(id)sender
{
//    CGImageRef imageRef = CGBitmapContextCreateImage(drawView.context);
//    
...
//    NSString *sss = [NSString stringWithFormat:@"%@%@", sss, @".png"];
//    NSString *filePath=[[NSString alloc]initWithString:[directory stringByAppendingPathComponent:sss]];    
...
//    UIImageWriteToSavedPhotosAlbum(image,self,nil,nil);     
    ...
    [UIImagePNGRepresentation([v currentContextImage]) writeToFile:filePath atomically:YES];
}
